...
const Footer = () => {
    return (
        <>
            <footer className="sm:pt-1 lg:pt-1 bg-black">
                <div className="pl-6 mb-3 sm:flex sm:pt-10 lg:flex lg:flex-row lg:pt-8 lg:items-center text-white">
                    <div className="sm:basis-3/6 sm:text-right sm:pr-10 lg:text-right lg:basis-2/5 lg:pr-20 lg:pt-0 lg:mt-1 text-[66px] uppercase font-bold">
                        KROOPP
                    </div>
                    <div className="sm:basis-2/6 sm:pt-6 lg:basis-3/5 lg:pt-0 lg:mt-0 uppercase text-xs font-mono">
                ...
                <div className="pl-6 sm:flex sm:pt-4 lg:flex lg:flex-row lg:pt-5 sm:pb-8 lg:pb-20 lg:mx-auto lg:max-w-6xl text-white">
                    ...
                    <div className="sm:basis-10/12 sm:flex sm:justify-between md:flex md:basis-10/12 md:items-start md:justify-between lg:basis-4/6 lg:flex lg:items-start lg:justify-between xl:basis-4/6 xl:flex xl:items-start xl:justify-between">
                        <div className="font-light mb-2 mr-3">                            <SubTitles title="about" />
                        ...
                        <div className="font-light">
                            ...
                            <div className="flex sm:flex md:flex lg:flex lg:mt-2">
                                <input type="email" placeholder="Email" className="pl-3 sm:pl-2 lg:w-full lg:pl-4 bg-black border border-white focus:border-white focus:outline-none text-xs rounded-l-full placeholder-white" />
                ...
                <div className="py-2 mt-4 sm:mt-0 sm:py-3 md:py-3 lg:py-3 xl:py-5 2xl:py-6" style={{ backgroundColor: "#131619" }}>
