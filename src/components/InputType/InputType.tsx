        ...
        <>
            <form className="p-8">
                ...
                <div className="flex mt-2">
                    ...
                    <div>
                        <input type="text" className="ml-2 bg-black w-[200px] h-[40px] border text-sm border-slate-300 rounded-full pl-5 p-2 placeholder:text-white" placeholder="Gender" />
                    </div>
                </div>
                <div className="flex mt-2">
                    <div>
